 ...
 * Wifi管理
 */
public class WiFiManagerNew extends BaseWiFiManager {

    private static final String TAG = "WiFiManager";
    private static WiFiManagerNew mWiFiManager;
    ...
    private WiFiManagerNew(Context context) {
        super(context);
    }

    public static WiFiManagerNew getInstance(Context context) {
        if (null == mWiFiManager) {
            synchronized (WiFiManagerNew.class) {
                if (null == mWiFiManager) {
                    mWiFiManager = new WiFiManagerNew(context);
                }
            }
        }
        return mWiFiManager;
    ...
    public boolean connectWEPNetwork(@NonNull String ssid, @NonNull String password) {
        Log.i(TAG, "connectWEPNetwork:  ssid:"+ssid+"    password:"+password);
...
//            boolean isSave = saveConfiguration();
    ...
    public boolean connectWPA2Network(@NonNull String ssid, @NonNull String password) {
        Log.i(TAG, "connectWPA2Network:  ssid:"+ssid+"    password:"+password);
